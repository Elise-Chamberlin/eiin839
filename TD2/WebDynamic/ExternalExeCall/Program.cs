...
namespace BasicServerHTTPlistener
{
    ...
    // exemple d'url:
    //localhost:8081/nice/evenements/myMethod?param1=concert&param2=danse
    //localhost:8081/listeUsers/user/myMethod?param1=elise&param2=chamberlin
    ...
    internal class Program
    {
        public static void myMethodExtern(string param1_value, string param2_value)
        {
            ...
            //start.FileName = @"D:\MesDossiers\Documents\Cours\POLYTECH\SEMESTRE8\Soc_WB\TD1\eiin839\TD2\WebDynamic\BasicWebServer\hello.sh"; // pour executer un script bash décommenter cette ligne et la suivante et mettre en commentaire la suite du code
            //Process process = Process.Start(start); 

            start.FileName = @"D:\MesDossiers\Documents\Cours\POLYTECH\SEMESTRE8\Soc_WB\TD1\eiin839\TD2\WebDynamic\myMethodExtern\bin\Debug\netcoreapp3.1\myMethodExtern.exe"; // Specify exe name.
